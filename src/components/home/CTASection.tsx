      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-10 text-sm text-primary-foreground/60">
            PayBill: <span className="font-bold text-primary-foreground">542542</span> | Account: <span className="font-bold text-primary-foreground">38549</span> • Response within 30 minutes
          </p>
        </div>
      </div>
    </section>
