...
import { useProducts, useProductCategories } from "@/data/contentStore";

type SortOption = "newest" | "price-low" | "price-high" | "name-az";

const Shop = () => {
  const products = useProducts();
  const customCategories = useProductCategories();
  const categories = useMemo(() => ["All", ...customCategories], [customCategories]);
